...
#####============================ HOW TO CITE ====================================##### 
## Silva Jr., L. (2021-2026). VVUnitAligner. Computer program for Praat (version 1.3).
## Available in: <https://github.com/leonidasjr/VVunitAlignerCode_webMAUS>
#####=============================================================================##### 

## Getting started...

form Phonetic re-alignment & Chunk segmentation procedures 
	#word Folder
	...
	positive Pause_duration_(s) 0.35
	boolean Save_TextGrid_files 1
endform
...
writeInfoLine: "============"
appendInfoLine: "Realignment process started..."
appendInfoLine: "============"
appendInfoLine: ""
stopwatch
...
for y from 1 to numberOfFiles
	...
	## Different languages require distinct procedures to be re-aligned and re-labeled
	...
	## Remove VV-derived temporary objects
	select TextGrid 'sound_file$'_V
...
## Counting the TextGrid files created
...
if save_TextGrid_files == 1
	appendInfoLine: "--------------------"
	appendInfoLine: numberOfTG, " '.TextGrid' files were created successfully"
	select all
...
writeInfoLine: "============"
appendInfoLine: "Realignment process ended."
appendInfoLine: "============"
appendInfoLine: ""
total_seconds = stopwatch
minutes = floor(total_seconds / 60)
seconds = total_seconds - (minutes * 60)
rounded_seconds = round(seconds * 100) / 100
appendInfoLine: "Elapsed time: ", minutes, " minutes and ", rounded_seconds, " seconds."
